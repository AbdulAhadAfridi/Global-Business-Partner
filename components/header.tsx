...
export function Header() {
  ...
  return (
    ...
    >
      <div className=" bg-gray-800 text-white hidden sm:flex">
        ...
        <div className="bg-gray-700 text-white border-b hidden sm:flex">
          <div className="container mx-auto px-2 sm:px-4 lg:px-6">
            <div className="flex items-center justify-between h-10 text-xs">
              {/* Left Section */}
              <div className="flex items-center space-x-2 sm:space-x-4">
      ...
      <div className="container mx-auto px-2 sm:px-4 lg:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="h-10 w-20 rounded  flex items-center justify-center transform group-hover:scale-110 transition-transform duration-200">
                   <Image
                    src="/jblogo.png"
                    alt="Logo"
                    width={70}
            ...
            <span className="font-bold text-lg sm:text-xl text-gray-900 group-hover:text-blue-600 transition-colors duration-200">
              Jodia<span className="text-orange-500">Bazar</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex flex-1 max-w-xs sm:max-w-md lg:max-w-2xl mx-4 sm:mx-6 lg:mx-8 group">
            <form
              ...
              className="flex w-full transition-all duration-300 group-hover:shadow-md "
            >
              <Input
                type="text"
                ...
                className="rounded-r-none border-r-0 border-gray-400 focus:ring-2 focus:ring-blue-500 transition-all duration-200 text-sm"
              />
              <Select defaultValue="pakistan">
                <SelectTrigger className=" border-gray-400 w-24 sm:w-36 lg:w-48 rounded-l-none rounded-r-none border-x-0 focus:ring-2 focus:ring-blue-500 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <Button
                type="submit"
                className="rounded-l-none bg-black hover:bg-orange-500 transform hover:scale-105 transition-all duration-200"
              >
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 text-xs sm:text-sm">
            ...
            >
              ...
              {cartItemCount > 0 && (
                <Badge
                  variant="secondary"
                  className="ml-1 text-xs bg-blue-100 text-blue-600 animate-pulse"
                >
                  {cartItemCount}
                </Badge>
              )}
            ...
            {user && (
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-56 animate-in fade-in-0 duration-200"
                >
          ...
          <div className="lg:hidden border-t py-4 animate-in slide-in-from-top duration-300">
            <div className="flex flex-col space-y-4 px-2">
              <form onSubmit={handleSearch} className="flex">
                ...
                <Button
                  type="submit"
                  className="rounded-l-none bg-blue-600 hover:bg-blue-700 transform hover:scale-105 transition-all duration-200"
                >
                  <Search className="h-4 w-4" />
                </Button>
              </form>
              ...
              <nav className="flex flex-col space-y-2">
                <Link
                  href="/businesses"
                  className="text-sm font-medium hover:text-blue-600 hover:bg-blue-50 py-2 rounded transition-all duration-200"
                >
                  All Businesses
                </Link>
                <Link
